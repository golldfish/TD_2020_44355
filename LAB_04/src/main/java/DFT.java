...
public class DFT {
    ...
    public ChartDetails makeAmplitude(List<Pair<Double, Double>> dft) {
        ...
        return new ChartDetails("DFT - amplitude", scores, "Frequency [Hz]", "Amplitude");
    }
    ...
    public ChartDetails decibelScale(ChartDetails amplitude) {
        ...
        return new ChartDetails("DFT spectrum with decibel scale", scores, "Frequency [Hz]", "Amplitude (dB)");
    }
}
...
public class chartX extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        calculateFunctions.calculateX(start, stop, ts, false).forEach(((x, y) -> seriesDFT.getData().add(new XYChart.Data(x, y))));
        calculateFunctions.calculateX(start, stop, ts, true).forEach((x, y) -> seriesIDFT.getData().add(new XYChart.Data(x, y)));
